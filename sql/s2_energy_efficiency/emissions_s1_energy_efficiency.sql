DELETE FROM emissions_all_buurt_s1 WHERE year = 2014 AND municipality = 'Delft';
...
WITH cbs_stats_buurt AS (
	SELECT * FROM cbs_map_all_buurt WHERE municipality = 'Delft' AND year = 2014
), 
housing_inuse AS (
	SELECT * FROM housing_inuse_2012_2021 WHERE municipality = 'Delft' AND year = 2014
), 
...
final_selection AS (
	SELECT 2014 AS year, municipality, wk_code, bu_code, bu_geom,  

...
ranked_demolitions AS (
    ...
    FROM temp_cdwaste w
    LEFT JOIN demolished_buildings b -- ON w.geom_28992 && ST_Expand(b.geom_28992, 100)
...
ranked_renovations AS (
    ...
    LEFT JOIN renovated_buildings b -- ON w.geom_28992 && ST_Expand(b.renovation_geom_28992, 100)
